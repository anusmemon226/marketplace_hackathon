...
const fetchProduct = async (slug: string) => {
    const resp = await fetch(`http://localhost:3000/api/product/${slug}`)
...
const page = async ({ params }: { params: { slug: string } }) => {
    ...
    const mainProductImage = product[0].main_image
        ? urlFor(product[0].main_image)?.width(550).height(310).url()
        : null;
        ...
        <div>
            <div className='bg-[#F9F1E7] py-5'>
                <div className='flex flex-wrap items-center gap-x-8 w-[90%] 2xl:w-[1240px] mx-auto'>
                    ...
                    <p className='text-[16px]'>{product[0].product_name}</p>
                </div>
            </div>
            <div className='w-[90%] 2xl:w-[1240px] mx-auto'>
                ...
                <div className='flex max-lg:flex-col gap-x-5 py-8'>
                    <div className='flex max-md:flex-col-reverse max-md:items-center max-lg:justify-center gap-x-3 lg:w-[50%]'>
                        <div className='max-md:flex max-sm:justify-center overflow-x-scroll max-md:gap-5 max-md:mt-4'>
                            {
                                product[0].product_images.map((item: any,index:any) => {
                                    const image = item
                                        ? urlFor(item)?.width(550).height(310).url()
                                        : null;
                                    return (
                                        <img key={index} src={image?image:""} style={{ width: "100px", height: "100px", objectFit: "contain" }} />
                                    )
                                })
                            }
                        ...
                        <div className='lg:flex-1'>
                            {mainProductImage && (
                                <img
                                    ...
                                    style={{ width: "500px", height: "420px", objectFit: "contain" }}
                                />
                            )}
                    ...
                    <div className='w-[100%]  lg:w-[50%]'>
                        <h1 className='text-[42px]'>{product[0].product_name}</h1>
                        <p className='text-[24px] font-medium text-[#9F9F9F]'>${product[0].price}</p>
                        ...
                        <p className='text-[16px] leading-[19.5px] sm:w-[450px] py-2'>{product[0].description.slice(0, 250)}...
                        </p>
                        <div className='py-3'>
                        ...
                        <div className=''>
                            ...
                            <div className='flex flex-wrap py-1'>
                                ...
                                <p className='flex-1 ml-2 text-[#9F9F9F] text-[16px]'>{product[0].category.category_name}</p>
                            </div>
                            {/* <div className='flex flex-wrap py-1'>
                                <div className='flex justify-between w-[80px]'>
                ...
                <div className='my-8'>
                    ...
                    <div className='w-[80%] mx-auto space-y-5 py-6'>
                        <p className='text-[16px] text-[#9F9F9F]'>{product[0]?.description}</p>
                    </div>
